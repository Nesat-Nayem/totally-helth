...
router.get('/', (0, authMiddleware_1.auth)(), menuCategory_controller_1.getMenuCategories);
router.get('/:id', (0, authMiddleware_1.auth)(), menuCategory_controller_1.getMenuCategoryById);
