...
const options: swaggerJSDoc.Options = {
  definition: {
    ...
    servers: [
      ...
      {
        url: 'https://totally-helth.vercel.app/v1/api',
...
export const setupSwagger = (app: Application): void => {
  // Custom HTML template for Vercel compatibility
  const customHtml = `
  <!DOCTYPE html>
  <html lang="en">
  <head>
    ...
    <title>🚀 Totally Helthy API Documentation</title>
  ...
  // Serve custom HTML for Swagger UI (Vercel compatible)
